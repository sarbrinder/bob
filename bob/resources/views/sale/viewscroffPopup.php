				<div class="row">
				    <input type="text" value="<?php echo $lastDate; ?>" readonly class="form-control" style="    margin-left: 18px;width: 115px;max-width: 139px;"/>
				
      
      
	    	                <div class="col-md-12 col-sm-12 col-xs-12 ">
					            <div class="detail-recents clearfix pull-left " id="">
			  ...
			  <tbody>
				...
				?>
					...
					<td id="slot<?php echo $data[$findOrder]->uniqueId;?>"><?php echo $data[$findOrder]->slotNo;?></td>	
					  ...
					  ?>
					  <td><input type="text" readonly class="form-control success scrEnterVal" name="scrEnterVal" /></td>
