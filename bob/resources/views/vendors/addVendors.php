		<div class="inventoryListDetail">
				<div class="row">
					<div class="breadcrumbs">
						<p class="pull-left">Location > Add Vendor</p>
						<p class="pull-right"><i class="fa fa-home"></i> / Add Vendor</p>
					</div>
				</div>
	...
	<div class="row">
	    	<div class="col-md-12 col-sm-12 col-xs-12 leftMainDiv">
					<div class="detail-recents clearfix pull-left" id="allRecords">
						<form action="<?php echo URL('/add-vendor');?>" class="profileSetting" id="profileSetting" method="post" accept-charset="utf-8">
							<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<div class="col-md-6">
								<div class="form-group"><label class="control-label">Name</label>
									<div class="form-group">
										<input class="form-control success" name="Name" placeholder="Name" type="text" />
								...
								<div class="form-group"><label class="control-label">Type</label>
									<div class="form-group">
										<select class="form-control success" name="type">
										    ...
										    <option value="2">Non-Retail</option>
										</select>
									</div>
									<div class="clearfix"></div>
								</div>
						...
						<div class="col-md-12">
						<input type="submit"  class="btn btn-primary checkForm savevendors" value="SAVE" />
					</div>
